...
import privateMessages from "./methods/private-messages";
import groupMessages from "./methods/group-messages";
...
contacts(userSchema);
privateMessages(userSchema);
groupMessages(userSchema);
